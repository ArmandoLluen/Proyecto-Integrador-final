...
import sys
import socket
from services.common.common import processControl
from services.common.utils import configLoader, dbTimestamp
...
def manageArgs():
    ...
    """
    parser = argparse.ArgumentParser(description="Main process for CyberBullying handling.")
    parser.add_argument('--proc', type=str, help="Process type: pre, apply", default="apply")
    parser.add_argument('--corpus', type=str, help="Corpus Name: TASS2019, cyberbully_1", default="TASS2019")
